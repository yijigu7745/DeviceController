...
public class Standard extends BaseEffect {
    ...
    protected void setInAnimation(View view) {
        getAnimatorSet().playTogether(
                ObjectAnimator.ofFloat(view, "translationY", -view.getHeight(), 10, 20, 5, 10, 0).setDuration(mDuration)
    ...
    protected void setOutAnimation(View view) {
        getAnimatorSet().playTogether(
                ObjectAnimator.ofFloat(view, "translationY", 0, 10, 5, -view.getHeight()).setDuration(mDuration)
